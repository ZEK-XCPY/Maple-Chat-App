...
const RightSidebar = () => {
  ...
  return (
    selectedUser && (
      ...
      <button onClick={()=>logout()} className="absolute bottom-2 left-1/2 -translate-x-1/2 bg-linear-to-r from-yellow-400 to-yellow-600 text-white border-none text-sm font-light py-2 px-20 rounded-full cursor-pointer">
  Logout
</button>
      </div>
    )
